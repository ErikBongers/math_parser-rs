...
(ErrorId::FuncArgWrongType, ErrorDef{id: ErrorId::FuncArgWrongType, error_type: ErrorType::E, name: "FuncArgWrongType", message: "Argument(s) for function `{0}` are of the wrong type. {1}"}),
...
(ErrorId::VarIsUnit, ErrorDef{id: ErrorId::VarIsUnit, error_type: ErrorType::E, name: "VarIsUnit", message: "Variable `{0}` overrides unit with same name."}),
