var cm = (function (exports) {
    ...
    */
    ...
    const lintGutterExtension = /*@__PURE__*/gutter$1({
    ...
    */
    ...
    // This file was generated by lezer-generator. You probably shouldn't edit it.
    const spec_identifier = {__proto__:null,true:26, false:26, instanceof:64};
    const parser = LRParser.deserialize({
      version: 13,
      states: "'tO`QROOO!QQTO'#ChO#bQRO'#CjO#bQRO'#CoO$zQTO'#D_O%[QTO'#D`OOQP'#D`'#D`OOQO'#D_'#D_OOQP'#Cb'#CbO#bQRO'#CbQ`QROOO&iQQO'#CeOOQP'#DW'#DWO&nQRO'#DTOOQP,59n,59nO&uQTO,59UO'|QQO,59ZO(RQQO,59[O#bQRO,59[O#bQRO,59`O#bQRO,59`O#bQRO,59`O#bQRO,59`O#bQRO,59`O#bQRO,59`OOQP,59m,59mO#bQRO'#DYO(WQQO,59qO#bQRO,59jOOQP,58|,58|OOQP-E7U-E7UOOQP,59P,59PO(fQTO'#DbO(pQQO,59oOOQP1G.u1G.uOOQP1G.v1G.vO(uQQO1G.vO*OQTO1G.zO*VQTO1G.zO+bQTO1G.zO+iQTO1G.zO,nQTO1G.zO,{QTO1G.zO-YQTO,59tOOQO-E7W-E7WO-jQTO1G/UO-zQRO'#DXO.UQQO,59|OOQP1G/Z1G/ZOOQP7+$b7+$bO.^QTO,59sOOQO-E7V-E7V",
      stateData: ".h~O!POS!QOSROSSOS~OPQOQQOVXOYUOZUO]UO_QO`QObRO!TPO~Ob]OP[XW[X`[Xe[Xf[Xi[Xj[Xk[Xl[Xm[Xn[Xo[Xp[Xq[Xs[Xt[Xx[Xa[Xg[X~OPQOQQOYUOZUO]UO_QO`QObRO!TPO~OPiO`eOeaOfbOicOjdOkdOldOmfOngOogOpgOqhO~OxjOW!RXa!RXg!RX~P$POslOtlOP!SXW!SX`!SXe!SXf!SXi!SXj!SXk!SXl!SXm!SXn!SXo!SXp!SXq!SXx!SXa!SXg!SX~OWoO~Oa!UP~P#bOeaOfbOP^aW^a`^ai^aj^ak^al^am^an^ao^ap^aq^ax^aa^ag^a~OarO~O!TsO~OxjOWyaayagya~Ox!OOa!UX~P$POa!QO~Og!RO~OPiOeaOfbOWhi`hijhikhilhimhinhiohiphiqhixhiahighi~Oihi~P(zOicO~P(zOPiOeaOfbOicOjdOkdOldOWhimhinhiohiphiqhixhiahighi~O`hi~P*^O`eO~P*^OPiO`eOeaOfbOicOjdOkdOldOmfOWhiqhixhiahighi~Onhiohiphi~P+pOngOogOpgO~P+pOW|ax|aa|ag|a~P$POWrixriarigri~P$POa{Xx{X~P#bOx!OOa!Ua~Oa{ax{a~P$PO",
      goto: "$}!VPPPPPP!WPP![PP!cP!uPPPP!u!cPPP!uPPPPPPPPP!uPP!u!u#XP#[#c#i#oPPPP#u$QP$zT[OYSWOYRmXqTOQRXY]bcdefghjl!OqUOQRXY]bcdefghjl!OR^PZVORXYbQYORnYQ!PpR!T!PQkSR|kUZOXYQ`RRtbYSORXYbQ_QQp]QucQvdQweQxfQygQzhQ{jQ}lR!S!ORq]",
      nodeNames: "⚠ ArithOp ArithOp LineComment BlockComment Script AnnotatedStatement Annot ; ExpressionStatement Number String VariableName BooleanLiteral UnaryExpression BitOp ArithOp ) ( ParenthesizedExpression MemberExpression . [ ] BinaryExpression ArithOp ArithOp ArithOp ArithOp BitOp CompareOp CompareOp instanceof CompareOp AssignmentExpression UpdateOp Equals PostfixExpression CallExpression ArgList , SequenceExpression",
      maxTerm: 52,
      context: trackNewline,
      nodeProps: [
        [NodeProp.group, 6,"Statement",-12,10,11,12,13,14,19,20,24,34,37,38,41,"Expression"],
        [NodeProp.openedBy, 17,"("],
        [NodeProp.closedBy, 18,")"]
      ],
      skippedNodes: [0,3,4],
      repeatNodeCount: 3,
      tokenData: "3V~R!UXY$eYZ%YZ[$e]^%Ypq$eqr%_rs%tst&htu&muv'Uvw'cwx'rxy(ayz(fz{(k{|)O|})W}!O)O!O!P)]!P!Q*k!Q!R+y!R![,k!]!^/S!^!_/X!_!`/q!`!a/y!a!b0a!c!}&m!}#O0g#P#Q0l#Q#R'l#R#S&m#T#o&m#p#q0q#r#s0z$f$g$e$g#BY&m#BY#BZ1P#BZ$IS&m$IS$I_1P$I_$I|&m$I|$I}2l$I}$JO2l$JO$JT&m$JT$JU1P$JU$KV&m$KV$KW1P$KW&FU&m&FU&FV1P&FV?HT&m?HT?HU1P?HU~&m~$jY!P~XY$eZ[$epq$e$f$g$e#BY#BZ$e$IS$I_$e$JT$JU$e$KV$KW$e&FU&FV$e?HT?HU$e~%_O!Q~R%dPVP!_!`%gQ%lPqQ!_!`%oQ%tOqQ~%yUZ~OY%tZr%trs&]s#O%t#O#P&b#P~%t~&bOZ~~&ePO~%tP&mOVP~&rU!T~tu&m!Q![&m!c!}&m#R#S&m#T#o&m$g~&m~'ZPk~!_!`'^~'cOs~~'fQvw'l!_!`'^~'oP!_!`'^~'wUZ~OY'rZw'rwx&]x#O'r#O#P(Z#P~'r~(^PO~'r~(fOb~~(kOa~~(pQl~z{(v!_!`'^~({Pi~!_!`'^~)TP`~!_!`'^~)]Ox~R)bPeQ!Q![)eP)jSYP!Q![)e!g!h)v#R#S)e#X#Y)vP)yS{|*V}!O*V!Q![*`#R#S*`P*YQ!Q![*`#R#S*`P*eQYP!Q![*`#R#S*`~*pRj~z{*y!P!Q+n!_!`'^~*|ROz*yz{+V{~*y~+YTOz*yz{+V{!P*y!P!Q+i!Q~*y~+nOS~~+sQR~OY+nZ~+nP,OXYP!O!P)e!Q![,k!g!h)v#R#S,k#U#V-X#X#Y)v#b#c-S#c#d-v#l#m._P,pUYP!O!P)e!Q![,k!g!h)v#R#S,k#X#Y)v#b#c-SP-XOYPP-[R!Q!R-e!R!S-e#R#S-eP-jSYP!Q!R-e!R!S-e#R#S-e#b#c-SP-yQ!Q!Y.P#R#S.PP.URYP!Q!Y.P#R#S.P#b#c-SP.bS!Q![.n!c!i.n#R#S.n#T#Z.nP.sTYP!Q![.n!c!i.n#R#S.n#T#Z.n#b#c-S~/XOW~~/^Qn~!^!_/d!_!`/l~/iPm~!_!`'^~/qOo~~/vPt~!_!`%g~0OQo~!_!`/l!`!a0U~0ZQm~!_!`'^!`!a/d~0dP!a!b'l~0lOf~~0qOg~~0tQ!_!`'^#p#q'l~1PO_~~1Wf!P~!T~XY$eZ[$epq$etu&m!Q![&m!c!}&m#R#S&m#T#o&m$f$g$e$g#BY&m#BY#BZ1P#BZ$IS&m$IS$I_1P$I_$JT&m$JT$JU1P$JU$KV&m$KV$KW1P$KW&FU&m&FU&FV1P&FV?HT&m?HT?HU1P?HU~&m~2sU!Q~!T~tu&m!Q![&m!c!}&m#R#S&m#T#o&m$g~&m",
      tokenizers: [incdecToken, 0, 1],
      topRules: {"Script":[0,5]},
      specialized: [{term: 51, get: value => spec_identifier[value] || -1}],
      tokenPrec: 0
    });

    var mathparserLanguage = LRLanguage.define({
        parser: parser.configure({
            props: [
                foldNodeProp.add({
                    "Block": foldInside$1,
                    BlockComment: function (tree) { return { from: tree.from + 2, to: tree.to - 2 }; }
                }),
                styleTags({
                    Super: tags.atom,
                    ...
                    ".": tags.derefOperator,
                    ", ;": tags.separator,
                    Annot: tags.processingInstruction
                })
            ]
        }),
        languageData: {
    ...
    function mathparser() {
        var lang = mathparserLanguage;
        return new LanguageSupport(lang, mathparserLanguage.data.of({}));
    }

    var _lintSource = undefined;
    function setLintSource(lintSource) {
        _lintSource = lintSource;
    }
    function mathparserLint() {
